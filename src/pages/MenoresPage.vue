  ...
  <div class="row q-pa-md q-gutter-xl">
    ...
    <div class="col-12 col-md-2 col-lg-2">
      ...
      <q-list bordered padding class="rounded-borders text-primary custom-shadow">
        ...
        <!-- Enlace a Listado -->
        <router-link :to="{ name: 'menores-listado' }" class="my-custom-router-link">
          <q-item clickable v-ripple :class="{ 'my-menu-link': activeLink === 'menores-listado' }">
        ...
        <!-- Enlace a Creación -->
        <router-link :to="{ name: 'menor-new' }" class="my-custom-router-link">
          <q-item clickable v-ripple :class="{ 'my-menu-link': activeLink === 'menor-new' }">
